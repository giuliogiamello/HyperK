...
Yesterday (HyperK#2025/10/13 - Attempt to install WCSim)[#2025/10/13 - Attempt to install WCSim] I found out that, in order to use `WCSim`, I need to install `Geant4-v10.3.3`. So I tried to install it following [[HyperK#Geant4 - Installation tutorial]]: it was working until the `make -j4` command.
